...
class Movie extends React.Component {
  render() {
      let url_backdrop = "http://image.tmdb.org/t/p/w500/" + this.props.movie.backdrop_path;
      let url_poster = "http://image.tmdb.org/t/p/w500/" + this.props.movie.poster_path;
      return (
...
export default class App extends React.Component {
  ...
  render() {
    if (this.state.movie != null) {
      console.log("movie object not null");
      return (
        <View style={styles.container}>
          ...
          {console.log("X:"+this.state.movieNameInput)}
        </View>
      )
    } else {
      console.log("movie object null");
      return (
        <View style={styles.container}>
          <TextInput style={styles.movieNameInput}
                     placeholder="Enter a movie name!"
